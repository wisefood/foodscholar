...
class ArticleEnricher:
    ...
    def enrich_article(self, article: ArticleInput) -> EnrichmentResponse:
        ...
        return EnrichmentResponse(
            ...
            tags=enriched.get("tags", ["Other"]),
            reader_group=enriched.get("reader_group", "Not stated"),
            age_group=enriched.get("age_group", enriched.get("population_group", "Not stated")),
            population_group=enriched.get("population_group", "Not stated"),
            geographic_context=enriched.get(
                "geographic_context",
                {"country_or_region": "Not stated", "income_setting": "Not stated"},
            ),
            biological_model=enriched.get("biological_model", "Not stated"),
            topics=enriched.get("topics", ["Other"]),
            study_type=enriched.get("study_type", "Not stated"),
            hard_exclusion_flags=enriched.get("hard_exclusion_flags", ["None"]),
            annotation_confidence=enriched.get("annotation_confidence", 0.0),
